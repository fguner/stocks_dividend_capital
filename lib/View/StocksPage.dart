...
class _StocksPageState extends State<StocksPage> {
  ...
  bool showAvg = false;
  String currentHisse,resultHistorical = "",month="";
                ...
                children: <Widget>[
                  ...
                  Padding(
                      padding: const EdgeInsets.only(
                          right: 0, left: 15, top: 10, bottom: 0)),
                  Text(
                    resultHistorical,
                    style: optionStyle,
                  ),
      ...
      if (result != null) {
        ...
        for (var item in Helper.dividends) {
          if (item.Code == currentHisse &&
            ...
            if (item.TypeCode == "02" || item.TypeCode == "03" || item.TypeCode == "09") {
